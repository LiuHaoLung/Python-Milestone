...
# # Absenteeism Exercise Machine Learning with Module

# #### Preparing the deployment of the model through a module

# It is about creating a mechanism to load a saved model and make predictions which is our 1th priority.
# 
# Generally, there are two approaches we can take, a clumsy and clever, the clumsy approach is the first that comes to mind, we can take all the code we've written and execute it this time feeding it with new data, as you can imagine, this would involve many setbacks and errors of all kinds syntactic, statistical and logical.
# 
# The clever approach, in practice we'd prefer creating a module and why would we want to do that, because storing code in a module will alows us to reuse it without trouble, in essence, we will treat the methods in this module in the same way we treat the numpy, sklearn and pandas methods.

# In[1]:


# it contains all the preprocessing and machine learning code
# given the Python is an OOP, everything is organized in classes
...
# create absenteeism_model class
# it consists of 5 methods:

# 1. __init__
# in the case to create an instance of absenteeism_model class
# there are two required arguments
# the model_file and scaler_file
# if they are correctly specified, init will pickle them and load the model information into the variable reg
# and the scaler file into the variable scaler

# 2. load_ and _clean_data
# takes csv as an argument and preprocess the data in the same way for the training part
# normally pass the data through this method to preprocess it
